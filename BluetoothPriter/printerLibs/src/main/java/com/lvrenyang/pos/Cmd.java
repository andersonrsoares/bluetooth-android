...
public class Cmd {
	...
	public static class PCmd {
		...
		// Programa de actualização, o parâmetro offset subscrito 4,5,6,7, e cabeçalho de checksum 10 e 11 para a validação de dados
	...
	public static class ESCCmd {
		...
		/**
		 * Enviar clara comprimento de dados de texto 0x00,0x00 texto simples. Você deve usar um número aleatório. Seguido de os dados são retornados dados em texto puro criptografados da ordem. O mesmo formato.
		 */
		...
		// / <summary>
		// / mprimir e linha de alimentação
		// / </summary>
